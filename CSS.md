...
- [CSS Properties](#css-properties)
  ...
  - [Colors](#colors)
    - [Hex Color System](#hex-color-system)
  ...
  - [Animation](#animation)
    - [Fill Mode of an Animation](#fill-mode-of-an-animation)
...
[Responsive Web Design Principles](#responsive-web-design-principles)
  - [Using `media` query](#using-media-query)
...
[**CSS FLEXBOX**](#css-flexbox)
  ...
  - [Adjust Flex Containers (NOT applied to specific items)](#adjust-flex-containers-not-applied-to-specific-items)
    ...
    - [Align Elements Along Main Axis Using `justify-content`](#align-elements-along-main-axis-using-justify-content)
    - [Align Elements Along Cross Axis Using `align-items`](#align-elements-along-cross-axis-using-align-items)
    - [Wrap a Row or Column Using `flex-wrap`](#wrap-a-row-or-column-using-flex-wrap)
  - [Affect Individual Flex Items (NOT applied to container)](#affect-individual-flex-items-not-applied-to-container)
    - [Control Size of Items When Container Shrinks: `flex-shrink`](#control-size-of-items-when-container-shrinks-flex-shrink)
    - [Control Size of Items When Container Expands: `flex-grow`](#control-size-of-items-when-container-expands-flex-grow)
    - [Set Initial Size of Item: `flex-basis`](#set-initial-size-of-item-flex-basis)
    - [Set Grow, Shrink, and Basis with One Line](#set-grow-shrink-and-basis-with-one-line)
...
[**CSS GRID**](#css-grid)
  ...
  - [Affect Individual Grid Elements](#affect-individual-grid-elements)
    ...
    - [Divide the Grid Into Custom Areas](#divide-the-grid-into-custom-areas)
    - [Assign Items to Custom Areas](#assign-items-to-custom-areas)
    - [Assign Items to Non-Defined Areas](#assign-items-to-non-defined-areas)
    - [Use `repeat` Function to Quickly Define Many Columns / Rows](#use-repeat-function-to-quickly-define-many-columns--rows)
    - [Limit Item Size Using `minmax`](#limit-item-size-using-minmax)
    - [Using `auto-fill` with `repeat` Function](#using-auto-fill-with-repeat-function)
